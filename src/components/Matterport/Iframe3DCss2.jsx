...
function Iframe3DCss2() {
    ...
    this.onInit = function () {
        ...
        if (!document.getElementById("rendererIframe")) {
        ...
        mesh.add(new Element(this.inputs.frameSRC, 0, 0, 240, 0));
...
function Iframe3DCSS2Factory() {
    return new Iframe3DCss2();
};
